                ...
                {socials.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-12 h-12 rounded-full bg-[#d3d8da]/10 flex items-center justify-center hover:bg-[#d3d8da] hover:text-[#161616] transition-all duration-300 hover:scale-110"
