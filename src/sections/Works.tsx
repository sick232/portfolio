...
const Works = () => {
  ...
  const projects = [
    ...
    description: 'AI-powered news concierge with zero-algorithm feed, real-time scraping, and personalized daily briefs',
    githubUrl: 'https://github.com/sick232/Up-2-Date',
    liveUrl: 'https://up-2-date-phi.vercel.app/'
    },
